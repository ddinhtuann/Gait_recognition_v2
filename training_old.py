...
from custom_dataset import getAllData_v2
...
def finetuneMultiGait(person_dir, n_chunk):
    ...
    gait_model.train(X_train, y_train_onehot,**params)
    print('finishlamlt')
...
if __name__ == "__main__":
    ...
    parser.add_argument('-n', type=int,help='number of images of a chunk', required=False)
